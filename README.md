...
- **[VTScan](https://github.com/nicoleman0/VTScan)**  
  VirusTotal API URL scanner to analyze URLs for malicious indicators.

- **[grctool](https://github.com/nicoleman0/grctool)**  
  Python utility for GRC automation, supporting governance, risk, and compliance tasks.
...
- **[ipster](https://github.com/nicoleman0/ipster)**  
  CLI tool for IP information lookups.

- **[Portfolio](https://github.com/nicoleman0/Portfolio)**  
  A collection of security projects and assignments.
...
- **[udemy_python_exercises](https://github.com/nicoleman0/udemy_python_exercises)**  
  Python practice from course exercises.
